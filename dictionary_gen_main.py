...
# -----------------------------
dict_file = 'data_gen/dictionary_diff_diff_data.pkl'
...
theta_bounds = [1,2,5, 8, 10,12, 15] #[1, 2,4 5, 6,8, 10, 12,15]
a_val_bound = [1.0]###[i/10 for i in range(5, 18)] ##[i/10 for i in range(5, 18)]

for bound in theta_bounds:
    for dimension in [5,10, 20]:  # Adjusted for example; originally was 2, 5, 10, 20
            ...
            for a_val in a_val_bound:
                ...
                for itr in range(iterations): ### however for cases with a_val  = 1.0 we have 10 runs
                    ...
                    if key in dict_diff_comp_theta_data:
                        ...
                        m = compare_reward_time_dml_no_time(
                            theta_bound=bound,
                            csv_index=itr,
                            dimension=dimension,
